-- ============================================================
--  BookNest Library Management System — Database Schema
--  Module 3: Book Master Data
-- ============================================================
...
-- ─── SEED DATA ──────────────────────────────────────────────
INSERT INTO books (isbn, title, author, publisher, year, genre, total_copies, available, description) VALUES
...
CREATE TABLE IF NOT EXISTS users (
    ...
    user_code     VARCHAR(10)  UNIQUE NOT NULL,   -- e.g. BN1023
